            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-600">87.5%</p>
                </div>
          ...
          <TabsContent value="roles" className="space-y-6">
            <Card className="border-blue-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-blue-900">Roles y Permisos</CardTitle>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2 pt-2">
                            ...
                            <Button variant="outline" size="sm" className="border-red-200 text-red-700 bg-transparent">
                              <Trash2 className="w-4 h-4" />
                            </Button>
                          </div>
                        </div>
